...
try:
    ...
    #     "mongodb+srv://circum:circum2023@cluster0.cs3vnxs.mongodb.net/?retryWrites=true&w=majority")
    client = pymongo.MongoClient(
        "mongodb://root:p4ssw0rd@localhost:27017/?retryWrites=true&w=majority")
